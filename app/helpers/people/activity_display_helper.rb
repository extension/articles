...
module People::ActivityDisplayHelper
  ...
  def activity_to_s(activity,opts = {})
    ...
    if(!activity.activity_application.nil?)
      aalink = nolink ? activity.activity_application.displayname : link_to_activity_application(activity.activity_application)
  ...
  def activityobject_uri_string(activityobject)
    if(activityobject.entrytype == ActivityObject::SYSWIKI_PAGE)
      ...
      return_uri_string = "#{activityobject.activity_application.link_uri}/expert/question/#{activityobject.foreignid}"
