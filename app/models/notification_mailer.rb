...
class NotificationMailer < ActionMailer::Base
  ...
  def confirm_email(notification)
   ...
   def aae_escalation_for_category(category, sincehours)
     ...
     escalation_users_for_category = User.notsystem_or_admin.validusers.escalators_by_category(category)
     if(escalation_emails = User.notsystem_or_admin.validusers.escalators_by_category(category))
