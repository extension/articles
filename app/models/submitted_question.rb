...
after_create :auto_assign_by_preference, :notify_submitter, :send_community_notifications
...
def send_community_notifications
  if self.widget and self.widget.group_notify == true and self.widget.assignees.length > 1
