class MigratePubsiteInstitutions < ActiveRecord::Migration
  def self.up
    ...
    execute "UPDATE institutions, pubsite_institutions SET institutions.public_uri = pubsite_institutions.uri, institutions.referer_domain = pubsite_institutions.domain, institutions.shared_logo = pubsite_institutions.shared WHERE institutions.code = pubsite_institutions.code "
