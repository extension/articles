class CopyWikiDinoTables < ActiveRecord::Migration
  def self.up
    ...
    create_table "bronto_deliveries", :force => true, :id => false do |t|
      t.string   "id", :null => false, :size => 40
      t.string   "bronto_message_id",  :null => false, :size => 40
    ...
    create_table "bronto_sends", :force => true do |t|
      t.string   "bronto_delivery_id", :null => false, :size => 40
      t.string   "bronto_message_id",  :null => false, :size => 40
      t.string   "bronto_recipient_id", :null => false, :size => 40
